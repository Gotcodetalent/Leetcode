...
- [1524-Number_of_Sub-arrays_With_Odd_Sum.cpp](Array/1524-Number_of_Sub-arrays_With_Odd_Sum.cpp) **(M)**
...
- [1749-Maximum_Absolute_Sum_Of_Any_Subarray.cpp](Array/1749-Maximum_Absolute_Sum_Of_Any_Subarray.cpp) **(M)**
...
- [2033-Minimum_Operations_to_Make_a_Uni-value_Grid.cpp](Array/2033-Minimum_Operations_to_Make_a_Uni-value_Grid.cpp) **(M)**
...
- [3169-Count_Days_Without_Meetings.cpp](Array/3169-Count_Days_Without_Meetings.cpp) **(M)**
- [3394-Check_If_Grid_Can_Be_Cut_Into_Sections.cpp](Array/3394-Check_If_Grid_Can_Be_Cut_Into_Sections.cpp) **(M)**
## [BFS](./BFS/)
...
- [2115-Find_All_Possible_Recipes_from_Given_Supplies.cpp](BFS/2115-Find_All_Possible_Recipes_from_Given_Supplies.cpp) **(M)**
## [BS](./BS/)
...
- [2551-Put_Marbles_in_Bags.cpp](Greedy/2551-Put_Marbles_in_Bags.cpp) **(H)**
...
## [Math](./Math/)
- [0007-Reverse_Integer.cpp](Math/0007-Reverse_Integer.cpp) **(M)**
...
- [0172-Factorial_Trailing_Zeroes.cpp](Math/0172-Factorial_Trailing_Zeroes.cpp) **(M)**
- [0190-Reverse_Bits.cpp](Math/0190-Reverse_Bits.cpp) **(E)**
- [0191-Number_of_1_Bits.cpp](Math/0191-Number_of_1_Bits.cpp) **(E)**
- [0201-Bitwise_AND_of_Numbers_Range.cpp](Math/0201-Bitwise_AND_of_Numbers_Range.cpp) **(M)**
...
- [2433-Find_The_Original_Array_of_Prefix_Xor.cpp](Math/2433-Find_The_Original_Array_of_Prefix_Xor.cpp) **(M)**
- [2680-Maximum_OR.cpp](Math/2680-Maximum_OR.cpp) **(M)**
...
- [2929-Distribute_Candies_Among_Children_II.cpp](Math/2929-Distribute_Candies_Among_Children_II.cpp) **(M)**
- [](Math/) **()**
- [](Math/) **()**
...
- [0076-Minimum_Window_Substring.cpp](SlidingWindows/0076-Minimum_Window_Substring.cpp) **(H)**
- [0209-Minimum_Size_Subarray_Sum.cpp](SlidingWindows/0209-Minimum_Size_Subarray_Sum.cpp) **(M)**
- [0220-Contains_Duplicate_III.cpp](SlidingWindows/0220-Contains_Duplicate_III.cpp) **(H)**
- [2379-Minimum_Recolors_to_Get_K_Consecutive_Black_Blocks.cpp](SlidingWindows/2379-Minimum_Recolors_to_Get_K_Consecutive_Black_Blocks.cpp) **(E)**
- [2904-Shortest_and_Lexicographically_Smallest_Beautiful_String.cpp](SlidingWindows/2904-Shortest_and_Lexicographically_Smallest_Beautiful_String.cpp) **(M)**
- [2957-Remove_Adjacent_Almost-Equal_Characters.cpp](SlidingWindows/2957-Remove_Adjacent_Almost-Equal_Characters.cpp) **(M)**
## [Stack](./Stack/)
...
- [1441-Build_an_Array_With_Stack_Operations.cpp](Stack/1441-Build_an_Array_With_Stack_Operations.cpp) **(M)**
